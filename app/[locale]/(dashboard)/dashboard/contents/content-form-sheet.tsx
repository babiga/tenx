...
export function ContentFormSheet({
    ...
    async function onSubmit(data: any) {
        ...
        try {
            ...
            if (!result.success) {
                toast.error(result.error || `Failed to ${isEdit ? "update" : "create"}`);
                return;
            }
                    ...
                    >
                        {(type === "BANNER" || type === "PARTNER") && (
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>{type === "BANNER" ? "Title" : "Name"}</FormLabel>
                                        <FormControl>
                                            <Input
                        ...
                        {(type === "BANNER" || type === "SOCIAL_LINK") && (
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {type === "BANNER" ? "Subtitle" : "Description (Optional)"}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                                                placeholder={type === "BANNER" ? "Subtitle" : "Description"}
                                                {...field}
                                                value={field.value || ""}
                                            />
                                        </FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Image URL {type !== "BANNER" && "(Optional)"}</FormLabel>
                                    <FormControl>
                                        <Input
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Link URL {type !== "SOCIAL_LINK" && "(Optional)"}</FormLabel>
                                    <FormControl>
                                        <Input
