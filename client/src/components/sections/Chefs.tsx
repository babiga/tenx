    ...
    <section id="chefs" className="py-24 bg-background border-t border-white/5">
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-end mb-16">
          <div>
            <h2 className="text-4xl md:text-5xl font-serif mb-2">Хоолны Урлагийн Мастерууд</h2>
            <p className="text-muted-foreground">Танд зориулсан амтны мастерууд.</p>
          </div>
          <a href="#" className="hidden md:block text-primary hover:text-white transition-colors underline decoration-primary/30 underline-offset-8">Бүх тогооч нарыг харах</a>
        </div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 z-20 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                <div className="flex items-center gap-2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                  ...
                  <span className="text-xs text-white/70">({chef.reviews} сэтгэгдэл)</span>
                </div>
        ...
        <div className="mt-12 text-center md:hidden">
          <a href="#" className="text-primary hover:text-white transition-colors underline decoration-primary/30 underline-offset-8">Бүх тогооч нарыг харах</a>
        </div>
      </div>
    </section>
  );
