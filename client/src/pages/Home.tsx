    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section id="for-chefs" className="py-24 bg-primary/5 border-y border-white/5 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
           <h2 className="text-4xl md:text-5xl font-serif mb-6 text-white">Дараагийн Арга Хэмжээгээ Шинэ Түвшинд Гаргаарай</h2>
           <p className="text-muted-foreground mb-10 max-w-2xl mx-auto text-lg leading-relaxed">Tenx Catering-ийн ялгааг мэдэр. Манай дэлхийн түвшний тогооч нар болон арга хэмжээний мэргэжилтнүүдийн баг таны алсын харааг мартагдашгүй бодит байдал болгон хувиргахад бэлэн байна.</p>
